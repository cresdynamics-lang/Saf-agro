  ...
  return (
    <section className="bg-light-grey py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <h2 className="section-heading mb-12">Why {spec.identification.gradeLabel.split("—")[0].trim()}</h2>

        <div className="grid gap-8 md:grid-cols-3">
          {spec.whyGrade.map((item, i) => (
            <article
              key={item.title}
              className="border-l-4 border-accent bg-white p-8 shadow-sm"
            >
              <div className="mb-4 text-primary">{icons[i % icons.length]}</div>
